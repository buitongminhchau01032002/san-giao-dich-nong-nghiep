        ...
        <View bg={'#1FA97C'} flex={1}>
            <View margin={4}  flexDirection={'row'}>
                ...
                <View alignSelf={'center'}>
                    <Text fontWeight={'semibold' } fontSize={18}>Nguyễn Văn A</Text>
                    <Text fontWeight={'light' } fontSize={14}>Nhà cung cấp</Text>
                </View>
            </View>
            <View paddingTop={'4'} bg={'white'} borderRadius={24} height={'full'} >
                <TouchableOpacity   onPress={()=>navigation.navigate('SupplierRegister')} >
                    <View  paddingRight={4}  paddingLeft={4} height={12} justifyContent={'space-between'} alignItems={'center'}   flexDirection={'row'}>
